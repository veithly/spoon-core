...
class LLMProviderRegistry:
    ...
    def get_capabilities(self, name: str) -> List[ProviderCapability]:
        ...
        # Try to get capabilities from existing instance
        if name in self._instances:
            try:
        ...
        # If no instance available, return empty list
        # In a real implementation, we might want to create a temporary instance
        return []
