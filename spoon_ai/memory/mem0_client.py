...
class SpoonMem0:
    ...
    def search_memory(self, query: str, user_id: Optional[str] = None) -> List[str]:
    ...
    def add_memory(self, messages: List[Any], user_id: Optional[str] = None) -> None:
        ...
        if self.metadata:
            add_kwargs["metadata"] = self.metadata
